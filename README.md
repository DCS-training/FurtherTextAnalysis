...
Inside this repository you are going to find an a Jupyter Notebooks that will allow learning how to perform advanced text analysis and a series of datasets (.txt and .csv files).
